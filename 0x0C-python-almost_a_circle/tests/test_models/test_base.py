...
class TestBase_instantiation(unittest.TestCase):
    """Unittestsesting instantiation of the Base class."""
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittest testing save_to_file method of Base class."""
    ...
    def test_save_to_file_one_rectangle(self):
        z = Rectangle(10, 7, 2, 8, 5)
        Rectangle.save_to_file([z])
        with open("Rectangle.json", "z") as f:
...
class TestBase_create(unittest.TestCase):
    """Unittest testing create method of Base class."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Unittest testing save_to_file_csv method of Base class."""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """Unittest testing load_from_file_csv method of Base class."""

    @classmethod
    def tearDown(self):
        """Delete any new created files."""
        try:
            os.remove("Rectangle.csv")
        except IOError:
            pass
